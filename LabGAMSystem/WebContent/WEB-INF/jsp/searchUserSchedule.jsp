		...
		<div class="col-lg-12">
			<div class="panel panel-default  wk-panel">
				<table class="table table-striped table-hover">
					...
					<tbody>
						<c:forEach items="${userSchedules}" var="var">
						<tr>
	...
	$("#deleteBtn").on("click", function() {
        ...
        if (id != "") {
            ...
            $("#deleteBtnOK").on("click", function() {
                location.href = "<%=basePath%>deleteUserSchedule/" + id + ".html";
            });
        }
    });
     ...
     $("#updateBtn").on("click", function() {
        ...
        if (id != "") {
			location.href = "<%=basePath%>updateUserSchedule/" + id + ".html";
        }
    });
